...
// Utils
import { exportClientes } from '@/utils/exportPDFUtils'

type Props = {
  clientes: Cliente[]
}

const ExportClienteMenu = ({ clientes }: Props) => {
  ...
  return (
    <>
      <Button
        ...
        onClick={handleClick}
        aria-controls={open ? 'export-cliente-menu' : undefined}
        aria-haspopup="true"
      ...
      <Menu
        id="export-cliente-menu"
        anchorEl={anchorEl}
        open={open}
        onClose={handleClose}
        MenuListProps={{
          'aria-labelledby': 'export-cliente-button',
        }}
      >
...
export default ExportClienteMenu
